...
@Autonomous(name = "BlueRight", group = "BlueRight")
public class BlueRight extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // telemetry.addData("FrontLeft Encoder", FrontLeft.getCurrentPosition());
                                    ...
                                    FrontLeft.setTargetPosition(1650);//drive forward to the A zone
                                    ...
                                    sleep(50);
                                    FrontLeft.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                                    FrontLeft.setTargetPosition(-50);//drive backwards slightly for room to turn
                                    ...
                                    sleep(50);
                                    FrontLeft.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                                    FrontLeft.setTargetPosition(-650);//turn 90 degrees to the left
                                    FrontLeft.setPower(-0.5);
                                    FrontRight.setPower(0.45);
                                    BackLeft.setPower(-0.5);
                                    BackRight.setPower(0.5);
                                    ...
                                    sleep(50);
                                    FrontLeft.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                                    FrontLeft.setTargetPosition(350);//drive forward slightly in front of power pegs
                                    FrontLeft.setPower(0.5);
                                    FrontRight.setPower(0.45);
                                    BackLeft.setPower(0.5);
                                    BackRight.setPower(0.5);
                                    ...
                                    sleep(50);
                                    FrontLeft.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                                    FrontLeft.setTargetPosition(650);//turn right 90 degrees to aim at the power pegs
                                    FrontLeft.setPower(0.5);
                                    FrontRight.setPower(-0.45);
                                    BackLeft.setPower(0.5);
                                    BackRight.setPower(-0.5);
